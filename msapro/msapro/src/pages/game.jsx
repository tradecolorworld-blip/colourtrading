...
const GameScreen = () => {
    ...
    return (
        <div className="min-h-screen bg-[#171222] text-[#c3c2e09a] font-['Poppins'] p-3 relative overflow-x-hidden">
            ...
            <div className="relative z-10 max-w-[420px] mx-auto">
                <div className="bg-[#1a1b32] border border-[#E2E8F0] rounded-[18px] p-5 shadow-lg text-center flex flex-col gap-4 mt-4">
                    ...
                    <div className="py-2">
                        ...
                        <h1 className="text-xl font-bold mt-4">{gameData.name}</h1>
                    </div>
                    ...
                    <div className="bg-[#1c1c36] border border-[#E2E8F0] p-2 rounded-xl grid grid-cols-4 gap-2">
                    ...
                    <div className="bg-[#191933] border border-[#E2E8F0] rounded-xl p-4 flex flex-col items-start gap-1 shadow-sm font-semibold text-[15px]">
